...
/// Wraps the speech_to_text package (permissions handled internally by the package)
class SpeechToTextService {
  final SpeechToText _speechToText = SpeechToText();
  bool _isInitialized = false;

  /// Check if speech recognition is available and initialize
  /// The speech_to_text package handles permission requests automatically
